					...
					<div class="col-lg-12">
						<div class="row">
							<div class="col-lg-12">
								...
								<s:iterator value="mediaList" status="mediaListStatus"
									var="media">
									<div class="row">
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<img src=<s:property value="filePath" />
														class="img-responsive" alt="Cinque Terre" width="75%"
														height="75%">
												</div>
												<div class="panel-footer">
													...
													<s:if test="ownerProp == 1">
														<a
															href="deleteMedia.action?mediaId=<s:property value="mediaId"/>"
						...
						<div class="row">
							<s:iterator value="commentList" status="mediaListStatus"
								var="comment">
								<div class="row">
									<s:property value="fullName" /> : <s:property value="comment" />
								</div>
							</s:iterator>
							<form name="commentForm" action="createNewComment.action"
								method="POST">
								<textarea rows="3" name="commentBox" class="form-control"></textarea>
								<input type="hidden" name="mediaId"
									value="<s:property value="mediaId"/>" /> <input type="submit"
									name="btnSubmit">
							</form>
						</div>
					</div>
